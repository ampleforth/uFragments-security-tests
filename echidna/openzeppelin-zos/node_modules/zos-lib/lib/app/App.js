...
class App {
  ...
  static async fetch() {
    return await _AppProvider2.default.from(...arguments);
  }

  static async deploy() {
    return await _AppDeployer2.default.deploy(...arguments);
  }

  static async deployWithStdlib() {
    return await _AppDeployer2.default.deployWithStdlib(...arguments);
  }

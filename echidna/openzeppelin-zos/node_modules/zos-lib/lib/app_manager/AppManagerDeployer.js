...
const log = new _Logger2.default('AppManagerDeployer');
...
exports.default = {
  ...
  async withStdlib(version, stdlibAddress, txParams = {}) {
    ...
    return new _AppManagerWrapper2.default(this.packagedAppManager, this.factory, this.appDirectory, this.package, this.version, this.txParams);
  },
